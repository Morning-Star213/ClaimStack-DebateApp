  ...
  return (
    <div className="space-y-4">
      ...
      />
        ...
        <label className="block text-sm font-medium text-[#666666] dark:text-gray-400 mb-2 mt-5">
        Perspective Type <span className="text-gray-400 dark:text-gray-500 text-xs">(Optional)</span>
        </label>
        <Dropdown
